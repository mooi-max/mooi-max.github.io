...
|​--network none​|-|网络隔离：关闭容器的所有网络功能，容器内只有lo​（本地回环），无法访问外网或局域网。|
|​yingji:v1​|-|镜像名称：使用名为yingji​标签为v1​的本地镜像。|
...
Q2:其中一个Webshell是冰蝎(Behinder)马，请找出其连接密钥和密码。提交方式：QHCTF{密钥_密码}
...
```
 grep -rE "[0-9]+\.[0-9]+\.[0-9]+\.[0-9]+" 2>/dev/null -A 3
```
...
```
QHCTF{/opt/.kthread/kthread,/opt/.X11-Xtrace/kworker}
```
...
> 
> ```
> nbtscan 10.27.220.191
> ```


![](../assets/QQ_1773302175652.png)

![](../assets/QQ_1773304429164.png)

![](../assets/image-20260312094957030.png)

![](../assets/image-20260312095056521.png)

![](../assets/Pasted-image-20260210101519.png)

![](../assets/QQ_1773299287539.png)